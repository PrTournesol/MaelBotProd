...
class roomGetter:
    def __init__(self, bot, chat_id, getHelpMessage):
        ...
        url = "https://edt.inp-toulouse.fr/jsp/custom/modules/plannings/anonymous_cal.jsp?resources=237,238,239,906,956,961,241,242,243,246,247,248,249,250,258,460,261,264,265,266,329,330,274,275,276,277,278,279,280,281,282,283,284,285,286,287,288,290,291,292,293,335,211,295,296,297,298,300,302,303,304,305,306,307,308,309,310,937,940,311,312,313,314,315,316,317,318,319&projectId=20&calType=ical&firstDate="\
            +self.currentDate\
            +"&lastDate="\
            +self.currentDate
        if (SUMMER_HOUR):
